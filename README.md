# 🗺️ Map-OS
A [WebOS](https://map-os.netlify.app/) based around travelling a map (your desktop) to access content and files
...
## 🌏 Features
- Custom made map using [Inkarnate](https://inkarnate.com/)
- Draggable windows for apps and files
- Automatically updating time and date
